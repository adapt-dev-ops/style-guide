...
(function () {
    ...
    function injectStyle() {
        ...
        var css = ''
        + 'site-youtube{overflow:hidden;}'
        + 'site-youtube .youtube-wrapper{display:block;position:relative;padding-bottom:56.25%;width:300%;left:-100%;box-sizing:border-box;}'
