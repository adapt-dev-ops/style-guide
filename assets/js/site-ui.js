...
* - 기간 노출: data-common-visible-month="2026-04-01~2026-04-30 00:00:00, 2026-06-01~2026-06-30 00:00:00" (쉼표 구간, ~로 시작·끝, 범위 밖이면 제거)
* ============================================================ */
(function (){
  var now = new Date();
  ...
  // 노출 처리
  $('[data-common-reserved-day]').each(function () {
      var start = parseDateTime($(this).data('common-reserved-day'));
      if (start && now >= start) {
  ...
  // 제거 처리
  $('[data-common-remove-day]').each(function () {
